...
export { EntityRelationManager } from "./core/entity-relation-manager.class";
...
export { EntityFieldMeta } from "./meta/meta-objects/entity-field-meta.class";
export { EntityMeta } from "./meta/meta-objects/entity-meta.class";
export { EntityRelationMeta } from "./meta/meta-objects/entity-relation-meta.class";
